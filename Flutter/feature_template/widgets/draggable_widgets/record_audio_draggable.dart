...
class DownloadAudioDraggable extends StatefulWidget {
  const DownloadAudioDraggable({Key? key, required this.dragging})
      : super(key: key);
//The dragging function call-backs to template and informs the parents widget somthing is dragged
  ...
  @override
  State<DownloadAudioDraggable> createState() => _DownloadAudioDraggableState();
}

class _DownloadAudioDraggableState extends State<DownloadAudioDraggable> {
  @override
  Widget build(BuildContext context) {
    ...
    return Draggable(
      ...
      data: const ["smallTile", "downloadAudio"],
          ...
          child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Icon(FontAwesomeIcons.fileAudio, color: customColor.background),
                ],
              )),
        ),
      ),
