...
class RosVideostreamDraggable extends StatefulWidget {
  const RosVideostreamDraggable({Key? key, required this.dragging})
      : super(key: key);
//The dragging function call-backs to template and informs the parents widget somthing is dragged
  ...
  @override
  State<RosVideostreamDraggable> createState() => _RosVideostreamDraggableState();
}

class _RosVideostreamDraggableState extends State<RosVideostreamDraggable> {
  @override
  Widget build(BuildContext context) {
    ...
    return Draggable(
      ...
      data: const ["bigTile", "ros-videostream"],
        ...
        child: Center(
            child: Column(
              ...
              children: [
                ...
                Icon(FontAwesomeIcons.tv, color: customColor.background),
              ],
            )),
      ),
    );
