...
class AvatarControllerDraggable extends StatefulWidget {
  const AvatarControllerDraggable({Key? key, required this.dragging})
      : super(key: key);
//The dragging function call-backs to template and informs the parents widget somthing is dragged
  ...
  @override
  State<AvatarControllerDraggable> createState() => _AvatarControllerDraggableState();
}

class _AvatarControllerDraggableState extends State<AvatarControllerDraggable> {
  @override
  Widget build(BuildContext context) {
    ...
    return Draggable(
      ...
      data: const ["bigTile", "avatar-controller"],
